...
<template>
  <div class="error-page bg-base">
    <div class="flex-1 flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        <div class="text-4xl font-dark font-bold">404 Not Found</div>
        <p class="text-2xl md:text-3xl font-light leading-normal">Sorry, we can't find this page</p>
        <p class="mt-2 mb-8">
          But don't worry, you can go back to the main page by clicking the button below
        </p>
